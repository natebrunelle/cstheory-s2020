...
remote=njb2b@portal.cs.virginia.edu:public_html/cstheory/f2020
...
then
    echo "doing schedule"
    python3 cal2html.py
    scp "assignments.json" "kytos:/var/www/html/cstheory/meta/"
    scp "coursegrade.json" "kytos:/var/www/html/cstheory/meta/"
fi
